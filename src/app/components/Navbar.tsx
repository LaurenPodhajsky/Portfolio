...
const Navbar = () => {
    ...
    return (
        <nav className='fixed w-full bg-white/80 dark:bg-dark/80 blackdrop-blur-sm z-50 border-b border-gray-200 dark:border-gray-700'>
            <div className='container max-w7xl mx-auto px-4'>
            {/*desktop menu*/}
            <div className='flex items-center justify-between h-16'>
                <Link href="/" className='text-lx font-bold text-primary'>Devfolio&trade;</Link>
                ...
                <div className='hidden md:flex items-center space-x-8'>
                    ...
                    {/*Color Theme Buttons*/}
                    <button onClick={toggleTheme} className='p-2 rounded-lg hover:bg-gray-100 hover:text-primary dark:hover:bg-gray-800 dark:text-white transition-colors cursor-pointer'>
                        {
                            theme === "dark" ? (
                ...
                isMobileMenuOpen && (
                    <div className='md:hidden'>
                        <div className='py-4 space-y-4'>
                            ...
                            {/*Color Theme Buttons*/}
                            <div>
                                <button onClick={toggleTheme} className='flex items-center py-2 hover:bg-gray-100 hover:text-white dark:hover:text-primary transition-colors'>
                                    {
                                        theme === "dark" ? (
